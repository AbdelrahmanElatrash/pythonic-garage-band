...
# @pytest.mark.skip("todo")     # skep it to not add any data to band
def test_band_name(reset_Band):
...
# @pytest.mark.skip("todo")
def test_instruments(one_band,reset_Band):
...
# @pytest.mark.skip("todo")
def test_individual_solos(one_band,reset_Band):
...
# @pytest.mark.skip("todo")
def test_band_members(one_band,reset_Band):
...
# @pytest.mark.skip("todo")
def test_play_solos_for_whole_band(one_band,reset_Band):
...
# @pytest.mark.skip("todo")                # filed the instance not empty   
